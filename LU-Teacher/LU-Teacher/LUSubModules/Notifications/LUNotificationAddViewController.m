//
//  LUNotificationAddViewController.m
//  LUTeacher
//
...
@interface LUNotificationAddViewController ()

@end

@implementation LUNotificationAddViewController
{
...
//    
//    LUNotificationViewController *pushToTeacherNotification = [self.storyboard instantiateViewControllerWithIdentifier:@"LUStudentNotificationVC"];
