...
//  //  LUTeacher
//
//  Created by Preeti Patil on 13/02/18.
//  Copyright © 2018 Set Infotech. All rights reserved.
//

#import "LUNotificationViewController.h"
#import "LUNotificationDetailCell.h"
#import "LUNotificationAddViewController.h"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LUNotificationDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    if (cell==nil) {
        cell= [[LUNotificationDetailCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:CellIdentifier];
