//
//  LUNotificationViewController.h
//  //  LUTeacher
//
...
@interface LUNotificationViewController : UIViewController< LUDelegate,UITextFieldDelegate, UIPopoverPresentationControllerDelegate>
