...
//    LULoginModel *loginModel;
  ...
  //  NSDictionary *userProfileDetails;
    ...
    //For Teacher
    NSArray *todayTTArray;
    NSDictionary *dockStudentList;
    //For Teacher Assignemnt
    NSDictionary *teacherAssignmentListDict;
    NSDictionary *teacherAssignemntEdit;
    NSDictionary *teacherAssignmentSubmit;
    NSDictionary *teacherAssignmentDelete;
    NSDictionary *syncArr;
    NSDictionary *teacherAssignmentPageType;
    
    // teacher resource
    NSDictionary *teacherResourcelist;
    
    NSArray *postResourceArray;
    NSDictionary *pageTypeDictionary;
    
    //Teacher OnlineExam
    NSDictionary *createExamDict;
    NSDictionary *examlistDict;
    NSDictionary *examReviewListDict;
    NSDictionary *examStudentSubmittedDict;
    NSDictionary *editExamDict;
    NSDictionary *getQuestionDetailsDict;
    NSDictionary *questToQuestPaperDict;
    //Teacher Drawing
    NSDictionary *drawingCategoryDict;
}
